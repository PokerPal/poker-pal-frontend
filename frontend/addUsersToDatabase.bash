...
curl -X POST "http://localhost:5000/leagues" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"name\":\"Main League\",\"allowChanges\":true,\"type\":\"Points\"}"
curl -X POST "http://localhost:5000/leagues" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"name\":\"Side League\",\"allowChanges\":true,\"type\":\"Cash\"}"
