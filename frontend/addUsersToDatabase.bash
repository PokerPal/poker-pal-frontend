...
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":1,\"totalScore\":1}"
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":2,\"totalScore\":2}"
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":3,\"totalScore\":3}"
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":4,\"totalScore\":4}"
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":5,\"totalScore\":5}"
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":6,\"totalScore\":6}"
curl -X POST "http://localhost:5000/sessions/1" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":7,\"totalScore\":7}"
curl -X POST "http://localhost:5000/sessions/1/finalize" -H "accept: text/plain"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":1,\"totalScore\":1}"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":2,\"totalScore\":2}"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":3,\"totalScore\":3}"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":4,\"totalScore\":4}"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":5,\"totalScore\":5}"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":6,\"totalScore\":6}"
curl -X POST "http://localhost:5000/sessions/2" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":7,\"totalScore\":7}"
curl -X POST "http://localhost:5000/sessions/2/finalize" -H "accept: text/plain"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":1,\"totalScore\":1}"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":2,\"totalScore\":2}"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":3,\"totalScore\":3}"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":4,\"totalScore\":4}"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":5,\"totalScore\":5}"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":6,\"totalScore\":6}"
curl -X POST "http://localhost:5000/sessions/3" -H "accept: text/plain" -H "Content-Type: application/json" -d "{\"userID\":7,\"totalScore\":7}"
